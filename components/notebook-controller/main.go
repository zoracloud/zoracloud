...
import (
	...
	"github.com/zoracloud/components/notebook-controller/controllers"
...
func init() {
	...
	utilruntime.Must(notebookv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2d1da5e1.zoracloud.ai",
	})
	if err != nil {
